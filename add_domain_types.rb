...
files_to_add = [
  'To Do List/Domain/Models/TaskType.swift',
  'To Do List/Domain/Models/TaskCategory.swift',
  'To Do List/Domain/Models/TaskEnergy.swift',
  'To Do List/Domain/Models/TaskContext.swift',
  'To Do List/Domain/Models/TaskRepeatPattern.swift',
  'To Do List/Domain/Constants/ProjectConstants.swift'
]
