...
- **Onboarding:** one question per step over the muted dawn hero video, a persistent Life Map orbit, personal promise, immediate CTA, and a skippable 1.2–1.4-second opening. Daily Loop stays central, the five roots stay on the inner ring, and chosen life areas assemble on the outer ring. The persisted map—not sample content—is the payoff and transforms into Home.
