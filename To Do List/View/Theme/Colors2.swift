...
////public typealias MSColors = Colors2
//
//@objc(MSFColors)
...
//        public struct Day {
//            public static var textPrimary = UIColor(light: Colors2.textSecondary, dark: Colors2.textPrimary)
//            public static var textSecondary: UIColor = Colors2.textSecondary
//            public static var textSelected: UIColor = textOnAccent
...
//            public static var selection = UIColor(light: Colors2.surfacePrimary, dark: Colors2.surfaceQuaternary)
