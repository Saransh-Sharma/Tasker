...
public enum TagMapper {
    ...
    public static func toDomain(from object: NSManagedObject) -> TagDefinition {
        TagDefinition(
    ...
    @discardableResult
    public static func apply(_ model: TagDefinition, to object: NSManagedObject) -> NSManagedObject {
