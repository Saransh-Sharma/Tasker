...
public enum TombstoneMapper {
    public static let entityName = "Tombstone"

    public static func toDomain(from object: NSManagedObject) -> TombstoneDefinition {
        TombstoneDefinition(
    ...
    @discardableResult
    public static func apply(_ model: TombstoneDefinition, to object: NSManagedObject) -> NSManagedObject {
