...
public enum SectionMapper {
    public static let entityName = "ProjectSection"

    public static func toDomain(from object: NSManagedObject) -> TaskerProjectSection {
    ...
    @discardableResult
    public static func apply(_ model: TaskerProjectSection, to object: NSManagedObject) -> NSManagedObject {
