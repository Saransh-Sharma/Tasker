...
struct SunriseTaskRowView: View, Equatable {
    ...
    nonisolated static func == (lhs: SunriseTaskRowView, rhs: SunriseTaskRowView) -> Bool {
...
#if DEBUG
struct SunriseTaskRowView_Previews: PreviewProvider {
