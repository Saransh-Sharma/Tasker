...
struct SunriseTaskListView: View {
    ...
    init(
        ...
        bottomContentInset: CGFloat = SunriseTaskListView.defaultBottomContentInset
    ) {
...
#if DEBUG
struct SunriseTaskListView_Previews: PreviewProvider {
