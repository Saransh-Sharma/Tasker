...
public struct TrackerDefinitionService: Sendable {
    private struct ExportEnvelope: Codable {
        var schemaVersion = 1
        var exportedAt: Date
        var definitions: [TrackerDefinitionValue]
        var entries: [TrackerEntryValue]
    ...
    public func saveDefinition(
        _ definition: TrackerDefinitionValue,
    ...
    public func archiveDefinition(_ definition: TrackerDefinitionValue, at date: Date = Date()) async throws {
    ...
    public func saveEntry(_ entry: TrackerEntryValue) async throws {
    ...
    private func validate(
        ...
        against definition: TrackerDefinitionValue
    ) throws {
...
public struct MedicationScheduleService: Sendable {
    private struct ExportEnvelope: Codable {
        var schemaVersion = 1
        var exportedAt: Date
        var medication: MedicationDefinitionValue
        var schedules: [MedicationScheduleValue]
        var events: [MedicationEventValue]
    ...
    public func saveDefinition(_ value: MedicationDefinitionValue) async throws {
    ...
    public func validateSchedule(_ value: MedicationScheduleValue) throws {
    ...
    public func saveSchedule(_ value: MedicationScheduleValue) async throws {
        try validateSchedule(value)
        try await repository.saveMedicationSchedule(value)
    }

    public func saveEvent(
        medication: MedicationDefinitionValue,
    ...
    public func resolve(
        medication: MedicationDefinitionValue,
        event: MedicationEventValue,
        as status: MedicationEventStatus,
        at date: Date = Date(),
        note: String? = nil
    ) async throws -> MedicationEventValue {
        if medication.startDate.map({ event.scheduledAt < $0 }) == true
            || medication.endDate.map({ event.scheduledAt > $0 }) == true {
            throw MedicationScheduleServiceError.eventOutsideActiveRange
        }
    ...
    public func updateRefill(
        ...
        remaining: Double,
        refilledAt: Date? = nil
    ) async throws -> MedicationDefinitionValue {
...
enum TrackerReminderPolicy {
    static func requests(for tracker: TrackerDefinitionValue) -> [TrackerReminderRequest] {
...
actor TrackerReminderCoordinator {
    ...
    func synchronize(_ tracker: TrackerDefinitionValue) async {
...
public final class CoreDataLifeBoardPhaseIIRepository: PhaseIIRepository, JournalBackupImportApplying, @unchecked Sendable {
    ...
    public func fetchTrackers() async throws -> [TrackerDefinitionValue] {
    ...
    public func saveTracker(_ value: TrackerDefinitionValue) async throws {
    ...
    public func fetchTrackerEntries(trackerID: UUID?) async throws -> [TrackerEntryValue] {
        try await read { context in
    ...
    public func saveTrackerEntry(_ value: TrackerEntryValue) async throws {
        try await write { context in
    ...
    public func saveMoodCheckIn(_ value: MoodEnergyCheckInValue) async throws {
        try await write { context in
    ...
    public func fetchMedications() async throws -> [MedicationDefinitionValue] {
        try await read { context in
    ...
    public func saveMedication(_ value: MedicationDefinitionValue) async throws {
        try await write { context in
            try HealthPrivacyMigrationAccess.requireValidated(in: context)
    ...
    public func fetchMedicationSchedules(medicationID: UUID?) async throws -> [MedicationScheduleValue] {
        try await read { context in
    ...
    public func saveMedicationSchedule(_ value: MedicationScheduleValue) async throws {
        try await write { context in
            try HealthPrivacyMigrationAccess.requireValidated(in: context)
    ...
    public func fetchMedicationEvents(from: Date, to: Date) async throws -> [MedicationEventValue] {
        try await read { context in
    ...
    public func saveMedicationEvent(_ value: MedicationEventValue) async throws {
        try await write { context in
            try HealthPrivacyMigrationAccess.requireValidated(in: context)
    ...
    public func fetchJournalDay(containing date: Date) async throws -> JournalDayValue? {
    ...
    public func saveJournalDay(_ value: JournalDayValue) async throws {
        try await write { context in
    ...
    public func fetchJournalDraft(dayID: UUID?) async throws -> JournalDraftValue? {
        try await read { context in
            ...
            return try JSONDecoder().decode(JournalDraftValue.self, from: payload)
        }
    }

    public func saveJournalDraft(_ value: JournalDraftValue) async throws {
        try await write { context in
    ...
    public func fetchKnowledgeSpaces() async throws -> [KnowledgeSpaceValue] {
        try await read { context in
    ...
    public func saveKnowledgeSpace(_ value: KnowledgeSpaceValue) async throws {
        try await write { context in
    ...
    public func fetchKnowledgeFolders(spaceID: UUID?) async throws -> [KnowledgeFolderValue] {
        try await read { context in
    ...
    public func saveKnowledgeFolder(_ value: KnowledgeFolderValue) async throws {
        try await write { context in
    ...
    public func fetchKnowledgeNotes(search: String?, spaceID: UUID?) async throws -> [KnowledgeNoteValue] {
        let values = try await read { context in
    ...
    public func fetchKnowledgeNotes(query: KnowledgeNoteQuery) async throws -> [KnowledgeNoteValue] {
    ...
    public func saveKnowledgeNote(_ value: KnowledgeNoteValue) async throws {
        try await write { context in
    ...
    public func fetchKnowledgeTags() async throws -> [KnowledgeTagValue] {
        try await read { context in
    ...
    public func saveKnowledgeTag(_ value: KnowledgeTagValue) async throws {
        try await write { context in
    ...
    public func fetchKnowledgeLinks() async throws -> [KnowledgeLinkValue] {
        try await read { context in
    ...
    public func saveKnowledgeLink(_ value: KnowledgeLinkValue) async throws {
    ...
    public func fetchKnowledgeAttachments(noteID: UUID) async throws -> [KnowledgeAttachmentValue] {
        try await read { context in
    ...
    public func saveKnowledgeAttachment(_ value: KnowledgeAttachmentValue) async throws {
        try await write { context in
    ...
    private static func writeJournalDay(_ value: JournalDayValue, in context: NSManagedObjectContext) throws {
    ...
    private static func remapJournalDay(_ input: JournalDayValue) -> JournalDayValue {
        let dayID = UUID()
    ...
    private static func trackerValue(_ object: NSManagedObject) -> TrackerDefinitionValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              let title = object.value(forKey: "title") as? String,
              let raw = object.value(forKey: "kindRaw") as? String,
              let kind = TrackerKind(rawValue: raw) else { return nil }
        return .init(
            id: id,
            title: title,
            kind: kind,
            ...
            createdAt: object.value(forKey: "createdAt") as? Date ?? Date(),
            updatedAt: object.value(forKey: "updatedAt") as? Date ?? Date(),
            valueType: (object.value(forKey: "valueTypeRaw") as? String).flatMap(TrackerKind.init(rawValue:)),
    ...
    private static func trackerEntryValue(_ object: NSManagedObject) -> TrackerEntryValue? {
        guard let id = object.value(forKey: "id") as? UUID,
    ...
    private static func moodValue(_ object: NSManagedObject) -> MoodEnergyCheckInValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              let raw = object.value(forKey: "moodRaw") as? String,
              let mood = JournalMood(rawValue: raw) else { return nil }
        return .init(
            id: id,
            mood: mood,
    ...
    private static func medicationValue(_ object: NSManagedObject) -> MedicationDefinitionValue? {
        guard let id = object.value(forKey: "id") as? UUID,
    ...
    private static func medicationScheduleValue(_ object: NSManagedObject) -> MedicationScheduleValue? {
        guard let id = object.value(forKey: "id") as? UUID,
    ...
    private static func medicationEventValue(_ object: NSManagedObject) -> MedicationEventValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              ...
              let status = MedicationEventStatus(rawValue: raw) else { return nil }
        return .init(
            id: id,
            medicationID: medicationID,
    ...
    private static func fastingValue(_ object: NSManagedObject) -> FastingSessionValue? {
        guard let id = object.value(forKey: "id") as? UUID,
        ...
        return .init(
            ...
            completionKind: object.entity.attributesByName["completionKindRaw"] == nil
                ? nil
                : (object.value(forKey: "completionKindRaw") as? String).flatMap(FastingCompletionKind.init(rawValue:)),
    ...
    private static func fastingTemplateValue(_ object: NSManagedObject) -> FastingTemplateValue? {
        guard let id = object.value(forKey: "id") as? UUID,
        ...
        return try? .init(
            ...
            displayPreferences: decode(
                FastingDisplayPreferences.self,
    ...
    private static func journalDayValue(_ object: NSManagedObject) -> JournalDayValue? {
        guard let id = object.value(forKey: "id") as? UUID,
    ...
    private static func journalBlockValue(_ object: NSManagedObject) -> JournalBlockValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              let dayID = object.value(forKey: "dayID") as? UUID,
              let raw = object.value(forKey: "kindRaw") as? String,
              let kind = JournalBlockKind(rawValue: raw) else { return nil }
        let mood = (object.value(forKey: "moodRaw") as? String).flatMap(JournalMood.init(rawValue:))
        return .init(
            id: id,
            dayID: dayID,
            kind: kind,
    ...
    private static func journalMediaValue(_ object: NSManagedObject) -> JournalMediaValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              let dayID = object.value(forKey: "dayID") as? UUID,
              let raw = object.value(forKey: "kindRaw") as? String,
              let kind = JournalMediaKind(rawValue: raw) else { return nil }
        ...
        return .init(
            ...
            createdAt: object.value(forKey: "createdAt") as? Date ?? Date(),
            syncPolicy: policyRaw.flatMap(JournalMediaSyncPolicy.init(rawValue:)) ?? (kind == .audio ? .protectedLocalOnly : .privateCloud)
        )
    }

    private static func spaceValue(_ object: NSManagedObject) -> KnowledgeSpaceValue? {
        guard let id = object.value(forKey: "id") as? UUID,
    ...
    private static func folderValue(_ object: NSManagedObject) -> KnowledgeFolderValue? {
        guard let id = object.value(forKey: "id") as? UUID,
    ...
    private static func noteValue(_ object: NSManagedObject) -> KnowledgeNoteValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              let spaceID = object.value(forKey: "spaceID") as? UUID,
              let title = object.value(forKey: "title") as? String else { return nil }
    ...
    private static func knowledgeBlockValue(_ object: NSManagedObject) -> KnowledgeBlockValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              let noteID = object.value(forKey: "noteID") as? UUID,
              let raw = object.value(forKey: "kindRaw") as? String,
              let kind = KnowledgeBlockKind(rawValue: raw) else { return nil }
        return .init(
            id: id,
            noteID: noteID,
            kind: kind,
    ...
    private static func tagValue(_ object: NSManagedObject) -> KnowledgeTagValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              let name = object.value(forKey: "name") as? String else { return nil }
        return .init(id: id, name: name, colorHex: object.value(forKey: "colorHex") as? String)
    }

    private static func linkValue(_ object: NSManagedObject) -> KnowledgeLinkValue? {
        guard let id = object.value(forKey: "id") as? UUID,
    ...
    private static func attachmentValue(_ object: NSManagedObject) -> KnowledgeAttachmentValue? {
        guard let id = object.value(forKey: "id") as? UUID,
              let noteID = object.value(forKey: "noteID") as? UUID,
