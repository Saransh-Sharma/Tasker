...
public struct InboxQuery: Equatable, Sendable {
...
/// a real `ActionReceipt` instead of a one-way trip.
...
public struct InboxReader: Sendable {
    ...
    public func items(for query: InboxQuery) async throws -> [InboxItem] {
