...
struct DaySwipeRestingPosition {
    static func centerY(
...
enum DaySwipeChromeVisibilityPolicy {
...
struct DaySwipeChromePresentation: Equatable {
    let offsetX: CGFloat
    let scaleX: CGFloat
    let scaleY: CGFloat
    let opacity: Double
    ...
    static func value(
    ...
    ) -> DaySwipeChromePresentation {
        if isChromeVisible {
            return DaySwipeChromePresentation(
                offsetX: 0,
                scaleX: 1,
                scaleY: 1,
                opacity: 1
        ...
        let distance = DaySwipeData.buttonRadius * 0.7
        return DaySwipeChromePresentation(
...
struct DaySwipeData: Equatable {
    ...
    func sized(to size: CGSize) -> DaySwipeData {
        DaySwipeData(
            side: side,
            centerY: centerY,
            progress: progress,
    ...
    func resting(at restingCenterY: CGFloat) -> DaySwipeData {
        DaySwipeData(
            side: side,
            centerY: centerY,
            progress: progress,
    ...
    func drag(translation: CGSize, location: CGPoint) -> DaySwipeData {
    ...
    static func side(forStartLocation location: CGPoint, containerSize: CGSize) -> DaySwipeSide? {
