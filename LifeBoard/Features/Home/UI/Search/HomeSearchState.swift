...
enum HomeSearchFocusPolicyResolver {
    static func shouldAutoFocusOnSearchEntry(layoutClass: LayoutClass) -> Bool {
...
@MainActor
protocol HomeSearchService: AnyObject {
...
@MainActor
final class HomeSearchEngineAdapter: HomeSearchService {
...
final class HomeSearchState: ObservableObject {
    ...
    private var engine: HomeSearchService?
    ...
    private func handleResults(_ tasks: [TaskDefinition], revision: Int) {
        ...
        PerformanceTrace.event("HomeSearchResultsApplied")
    }
