...
// Mass clustering — how anchors that crowd one part of the day are
// spaced along the stream — and the view that draws the result.

// MARK: - TimelineStreamGeometry+MassClustering
