...
// How the canvas turns a day into positions.

// MARK: - TimelineCanvasLayoutPlan
...
// MARK: - TimelineCanvasLayoutPlan+Positioning
...
struct TimelineSurfaceMetrics {
    ...
    static func make(for layoutClass: LayoutClass) -> TimelineSurfaceMetrics {
...
// MARK: - TimelineBottomProtectionBudget
...
struct TimelineBottomProtectionBudget: Equatable {
    ...
    static func make(for layoutClass: LayoutClass) -> TimelineBottomProtectionBudget {
        switch layoutClass {
        case .phone:
