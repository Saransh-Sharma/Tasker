...
extension HomeViewModel {
    ...
    func applyReloadScopes(
        ...
        if scopes.contains(.habits) {
            let interval = PerformanceTrace.begin("HomeHabitScopedReload")
    ...
    func applyFocusFilters(
        ...
        let interval = PerformanceTrace.begin("HomeApplyFilters")
        ...
        homeFilteredTasksUseCase.execute(
            ...
            Task { @MainActor in
                ...
                guard self.isCurrentReloadGeneration(generation) else {
                    ...
                    PerformanceTrace.event("HomeDaySwipeStaleDrop")
                    return
                }
        ...
        for dayOffset in [-1, 1] {
            ...
            homeFilteredTasksUseCase.execute(
                ...
                if case .success = result {
                    PerformanceTrace.event("HomeDaySwipePrefetchReady")
                }
            }
        }
    }
