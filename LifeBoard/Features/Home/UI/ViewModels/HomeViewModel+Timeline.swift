...
extension HomeViewModel {
    func buildTimelineSnapshot(
        ...
        let interval = PerformanceTrace.begin("HomeTimelineSnapshotBuild")
...
extension HomeViewModel {
    ...
    func timelinePlanItem(from event: CalendarEventSnapshot) -> TimelinePlanItem {
        TimelinePlanItem(
            id: "event:\(event.id)",
    ...
    func timelineIsMeetingLikeEvent(_ event: CalendarEventSnapshot) -> Bool {
