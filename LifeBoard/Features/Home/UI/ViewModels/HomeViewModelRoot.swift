...
public final class HomeViewModel: ObservableObject {
    ...
    let workspacePreferencesProvider: () -> WorkspacePreferences
    ...
    var pendingHabitMutationIntervals: [HomeHabitMutationKey: PerformanceInterval] = [:]
    ...
    init(
        ...
        workspacePreferencesProvider: @escaping () -> WorkspacePreferences = { WorkspacePreferencesStore.shared.load() },
