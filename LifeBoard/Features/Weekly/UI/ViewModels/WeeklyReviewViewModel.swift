...
public final class WeeklyReviewViewModel: ObservableObject {
    ...
    public init(
        ...
        weekStartsOn: Weekday = WorkspacePreferencesStore.shared.load().weekStartsOn,
        ...
        self.weekStartDate = XPCalculationService.startOfWeek(
            for: referenceDate,
    ...
    private func awardWeeklyReviewXP(using decisions: [WeeklyReviewTaskDecision]) {
        ...
        let weekKey = XPCalculationService.periodKey(for: weekStartDate)
