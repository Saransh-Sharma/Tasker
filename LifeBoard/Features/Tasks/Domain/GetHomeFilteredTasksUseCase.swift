...
public final class GetHomeFilteredTasksUseCase: @unchecked Sendable {
    ...
    public func execute(
        ...
        let interval = PerformanceTrace.begin("HomeFilterQuery")
        let projectionInterval = PerformanceTrace.begin("HomeFilterExactProjection")
        ...
        fetchHomeProjection(
            ...
            defer {
                PerformanceTrace.end(projectionInterval)
