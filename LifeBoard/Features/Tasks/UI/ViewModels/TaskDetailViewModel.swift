...
public final class TaskDetailViewModel: ObservableObject {
    ...
    public typealias TaskFitHintHandler = (TaskDefinition, @escaping @MainActor @Sendable (TaskFitHintResult) -> Void) -> Void
    ...
    @Published public private(set) var taskFitHint: TaskFitHintResult = .unknown
    ...
    public func refreshMetadata() {
        ...
        let interval = PerformanceTrace.begin("TaskDetailEditingMetadataLoad")
    ...
    public func refreshRelationshipMetadata() {
        ...
        let interval = PerformanceTrace.begin("TaskDetailRelationshipMetadataLoad")
    ...
    public func refreshChildren() {
        ...
        let interval = PerformanceTrace.begin("TaskDetailChildrenLoad")
