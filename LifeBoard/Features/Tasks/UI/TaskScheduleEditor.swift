...
enum TimelineAnchorSelection: String, Equatable, Identifiable {
    ...
    func date(from preferences: WorkspacePreferences, calendar: Calendar = .current) -> Date {
        switch self {
        case .wake:
            return Self.date(
    ...
    func slotBaseDate(from preferences: WorkspacePreferences, calendar: Calendar = .current) -> Date {
        switch self {
        case .wake:
    ...
    func save(time: Date, to store: WorkspacePreferencesStore, calendar: Calendar = .current) {
...
struct TimelineAnchorDraft {
    ...
    init(preferences: WorkspacePreferences, calendar: Calendar = .current) {
    ...
    func commitIfNeeded(for selection: TimelineAnchorSelection, to store: WorkspacePreferencesStore) {
...
struct TimelineAnchorDetailSheetView: View {
    ...
    let preferencesStore: WorkspacePreferencesStore
