...
struct ComposerOption<ID: Hashable>: Identifiable {
    let id: ID
    let title: String
    let icon: String?
...
struct ComposerOptionGrid<ID: Hashable>: View {
    let title: String
    let helperText: String?
    let options: [ComposerOption<ID>]
    let selectedID: ID?
...
struct ComposerDisclosureRow: View {
    let title: String
    let summary: String
    let isExpanded: Bool
    let accessibilityIdentifier: String?
