...
public struct LifeBoardRecoveryStatus: Equatable, Sendable {
...
/// Builds a `LifeBoardRecoveryStatus` from the subsystems that already track it.
///
...
public struct LifeBoardRecoveryStatusService: Sendable {
    ...
    public func status() -> LifeBoardRecoveryStatus {
        var areas: [LifeBoardRecoveryStatus.Area] = []
        ...
        return LifeBoardRecoveryStatus(areas: areas, generatedAt: now())
    }
    ...
    private func indexArea(
        ...
        recovery: LifeBoardRecoveryStatus.Recovery
    ) -> LifeBoardRecoveryStatus.Area {
        switch state {
        case .ready:
...
extension LifeBoardRecoveryStatusService {
