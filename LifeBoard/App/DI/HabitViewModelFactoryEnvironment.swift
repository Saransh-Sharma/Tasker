...
/// `CompositionRoot.shared`: it hides what a view actually
...
extension CompositionRoot: HabitViewModelFactory {}
...
private struct HabitViewModelFactoryKey: @preconcurrency EnvironmentKey {
    ...
    static let defaultValue: any HabitViewModelFactory = CompositionRoot.shared
}
...
enum HabitComposerViewModels {
    static func makeNew() -> AddHabitViewModel {
        CompositionRoot.shared.makeNewAddHabitViewModel()
    }
}
...
enum SettingsServices {
    static var notificationService: (any NotificationServiceProtocol)? {
        CompositionRoot.shared.notificationService
    }
}
...
enum RecoveryServices {
    ...
    static func journalIndexState() async -> RecoveryStatusService.DerivedIndexState? {
        ...
        return RecoveryStatusService.classifyIndex(
