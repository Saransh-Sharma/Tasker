...
struct RecoveryCenterView: View {
    ...
    let status: LifeBoardRecoveryStatus
    /// Returns the human-readable outcome to announce when the work finishes.
    let onRecover: (LifeBoardRecoveryStatus.Recovery) async -> String
    let onExportDiagnostics: () -> Void

    @State private var runningRecovery: LifeBoardRecoveryStatus.Recovery?
    ...
    @ViewBuilder
    private func areaRow(_ area: LifeBoardRecoveryStatus.Area) -> some View {
    ...
    private func indicator(for health: LifeBoardRecoveryStatus.Health) -> some View {
    ...
    private func symbol(for health: LifeBoardRecoveryStatus.Health) -> String {
        switch health {
    ...
    private func tint(for health: LifeBoardRecoveryStatus.Health) -> Color {
        switch health {
    ...
    private func accessibilityLabel(for health: LifeBoardRecoveryStatus.Health) -> String {
        switch health {
    ...
    private func run(_ recovery: LifeBoardRecoveryStatus.Recovery) {
