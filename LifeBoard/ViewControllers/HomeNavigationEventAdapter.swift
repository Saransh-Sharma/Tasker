...
@MainActor
final class LifeBoardNavigationEventCoordinator: HomeNavigationEventAdapterDelegate {
    ...
    func start() {
        eventAdapter.start()
        if let route = LifeBoardNotificationRouteBus.shared.consumePendingRoute() {
