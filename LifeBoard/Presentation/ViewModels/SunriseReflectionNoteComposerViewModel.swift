...
/// Canonical ReflectionNote composer used by task, project, and weekly-review
/// surfaces. Despite the historical filename, it writes only durable journal
/// notes and has no dependency on the retired Daily Reflection store.
@MainActor
