...
> **Classification: Audit snapshot.** Current Habit behavior is defined by the [Habit package](../habits/README.md); current completion is owned by the [Unified Completion Status](../life-os/LIFEBOARD_UNIFIED_COMPLETION_STATUS.md).
Date: 2026-04-17
