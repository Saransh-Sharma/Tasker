...
- [x] Route planner and review using the resolved target week and dynamic planner copy
- [x] Add focused regression tests for workspace preference persistence and weekly summary resolution
- [x] Run focused build and weekly test validation
