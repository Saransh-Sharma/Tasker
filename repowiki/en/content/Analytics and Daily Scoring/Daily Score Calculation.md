...
**Section sources**
- [TaskScoringService.swift](file://To Do List/Services/TaskScoringService.swift#L55-L58)
...
**Diagram sources**
- [TaskScoringService.swift](file://To Do List/Services/TaskScoringService.swift#L50-L90)
- [TaskRepository.swift](file://To Do List/Repositories/TaskRepository.swift#L5-L15)
- [CoreDataTaskRepository.swift](file://To Do List/Repositories/CoreDataTaskRepository.swift#L50-L70)
...
**Section sources**
- [TaskScoringService.swift](file://To Do List/Services/TaskScoringService.swift#L75-L85)
- [CoreDataTaskRepository.swift](file://To Do List/Repositories/CoreDataTaskRepository.swift#L55-L65)

## Real-World Example: Score Calculation on May 1st
Consider a user who completes two high-priority tasks and one medium-priority task on May 1st. The `calculateTotalScore(for:using:completion:)` method is called with `Date()` representing May 1st. The `NSPredicate` filters all `NTask` entities where `dateCompleted` is between May 1st, 00:00:00 and May 2nd, 00:00:00, and `isComplete` is true. The repository returns these three tasks. The scoring service iterates over them: each high-priority task is worth 7 points, contributing 14 points total, and the medium-priority task is worth 4 points. The sum of 14 + 4 equals 18. This total score of 18 is then delivered to the completion handler. This example demonstrates the additive nature of the scoring system and how priority directly influences the final score, providing a tangible reward for completing more important tasks.

**Section sources**
- [TaskScoringService.swift](file://To Do List/Services/TaskScoringService.swift#L50-L90)
- [TaskScoringService.swift](file://To Do List/Services/TaskScoringService.swift#L30-L45)
...
**Diagram sources**
- [HomeViewController.swift](file://To Do List/ViewControllers/HomeViewController.swift#L1050-L1075)
- [TaskScoringService.swift](file://To Do List/Services/TaskScoringService.swift#L50-L90)
