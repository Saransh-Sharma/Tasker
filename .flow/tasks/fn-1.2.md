# fn-1.2 Standardize logging framework and policy

## Description
TBD

## Acceptance
- [ ] LoggingService supports standardized key-value event logs
- [ ] Default level is warning/error/fatal only
- [ ] Launch arg `-TASKER_VERBOSE_LOGS` enables debug verbosity
- [ ] Legacy message log wrappers route to standardized formatter
